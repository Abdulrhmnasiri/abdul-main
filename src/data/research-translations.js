  ...
  ar: {
    ...
    sections: {
      ...
      expression: {
        ...
        initialLabel: 'الوصف الأولي',
        questionLabel: 'سؤال كشف السياق',
        clarifiedLabel: 'الصياغة بعد التوضيح',
        examples: [
          {
            directionLabel: 'المالية والمحاسبة والتأمين',
            initial: 'أراجع الفواتير.',
            question: 'عندما تراجع الفاتورة، هل تتحقق فقط من ظاهرها، أم تطابقها مع أوامر الشراء والمستندات المؤيدة وتوثق الفروقات قبل إحالتها؟',
            clarified: 'أراجع الفواتير وأطابق بياناتها مع أوامر الشراء والمستندات المؤيدة، وأوثق الفروقات قبل إحالتها للمعالجة.',
          },
          {
            directionLabel: 'إدارة الأعمال والعمليات',
            initial: 'أتابع الطلبات.',
            question: 'هل تقتصر المتابعة على معرفة الحالة، أم تتابع الطلب عبر مراحله، وتنسق مع الأطراف المعنية، وتوثق حالات التعثر أو تصعدها عند الحاجة؟',
            clarified: 'أتابع الطلبات عبر مراحلها، وأنسق مع الأطراف المعنية، وأوثق حالات التعثر حتى اكتمال الإجراء أو تصعيده.',
          },
          {
            directionLabel: 'الدعم التقني والتقنية الرقمية',
            initial: 'أتابع مشكلات النظام وأرفعها للفريق التقني.',
            question: 'قبل التصعيد، هل تتحقق من المشكلة وتعيد إنتاجها وتوثق السلوك المتوقع والفعلي والمعلومات التي يحتاجها الفريق التقني؟',
            clarified: 'أحلل بلاغات المستخدمين، وأعيد إنتاج المشكلة عند الإمكان، وأوثق السلوك المتوقع والفعلي قبل تصعيدها للفريق التقني.',
          },
        ],
      ...
      domains: {
        ...
        list: [
          { title: 'الدعم التقني والتقنية الرقمية', body: 'يمتد هذا الاتجاه عبر تطوير البرمجيات والأنظمة والتطبيقات، والبيانات والتحليلات، والبنية التحتية والشبكات والسحابة، والأمن السيبراني، والدعم والعمليات الرقمية. يركز البحث على فهم طبيعة مساهمة الشخص داخل هذا الطيف: هل يبني التقنية، أم يشغّلها، أم يحللها، أم يحميها، أم يدعم مستخدميها، وما الأدلة التي تسند خبرته.' },
          { title: 'إدارة الأعمال والعمليات', body: 'يشمل هذا الاتجاه الأعمال الإدارية والتشغيلية، وإدارة سير العمل، وتنسيق المشاريع والبرامج، والجودة والتحسين المستمر، والمشتريات والتقارير والمتابعة. يميز البحث بين متابعة التنفيذ، وتنسيق الأطراف، وتحليل الأداء، وتحمل مسؤولية الإجراء أو القرار ضمن نطاق الدور.' },
          { title: 'المبيعات والتجزئة وتجربة العميل', body: 'يشمل هذا الاتجاه المبيعات المباشرة والاستشارية، وعمليات التجزئة، وإدارة الحسابات والعلاقات، وخدمة العملاء وتجربتهم، وما بعد البيع وعمليات المبيعات. يركز البحث على الفرق بين معالجة التفاعل، وبناء العلاقة، وإدارة الحساب، وتحمل مسؤولية تجارية يستطيع الشخص إثباتها دون افتراض أهداف أو نتائج.' },
          { title: 'المالية والمحاسبة والتأمين', body: 'يمتد هذا الاتجاه من العمليات المحاسبية والمعاملات والمطابقات إلى التقارير والرقابة والتدقيق وعمليات التأمين والتحليل المالي ضمن حدود الدور. يميز البحث بين الإدخال والمراجعة والمطابقة والتحليل والرقابة ودعم القرار، مع الانتباه إلى مستوى الدقة والمسؤولية الفعلية.' },
          { title: 'السياحة والضيافة والفعاليات', body: 'يشمل هذا الاتجاه عمليات الضيافة والسفر والحجوزات وتجربة الضيف والواجهات الأمامية، إضافة إلى تخطيط الفعاليات وتنفيذها والتنسيق الميداني. يركز البحث على الفرق بين تقديم الخدمة، وتنسيق التشغيل، وتحمل مسؤولية تجربة الضيف، والتخطيط، والتصرف المهني في المواقف المتغيرة.' },
        ],
        noteLabel: 'توضيح',
        note: 'يساعد اختيار الاتجاه على قراءة الخبرة داخل بيئتها المهنية، لكنه لا يمنح تصنيفًا رسميًا ولا يحدد مسمى وظيفيًا أو هوية مهنية نهائية.',
      },
  ...
  en: {
    ...
    sections: {
      ...
      expression: {
        ...
        initialLabel: 'Initial description',
        questionLabel: 'Context question',
        clarifiedLabel: 'Wording after clarification',
        examples: [
          {
            directionLabel: 'Finance, Accounting & Insurance',
            initial: 'I review invoices.',
            question: 'When reviewing an invoice, do you only check its visible details, or do you match it against purchase orders and supporting documents and record discrepancies before referring it for action?',
            clarified: 'I review invoices, match their details against purchase orders and supporting documents, and document discrepancies before referring them for further action.',
          },
          {
            directionLabel: 'Business Administration & Operations',
            initial: 'I follow up on requests.',
            question: 'Does your follow-up stop at checking the status, or do you track the request through its stages, coordinate with the relevant parties, and record or escalate blockers when needed?',
            clarified: 'I track requests through their stages, coordinate with the relevant parties, and document blockers until the process is completed or escalated.',
          },
          {
            directionLabel: 'Technical Support & Digital Technology',
            initial: 'I follow up on system issues and escalate them to the technical team.',
            question: 'Before escalation, do you investigate the issue, reproduce it, and document the expected and actual behavior and the information the technical team needs?',
            clarified: 'I analyze user-reported issues, reproduce the problem where possible, and document the expected and actual behavior before escalating it to the technical team.',
          },
        ],
        noteLabel: 'The line',
      ...
      domains: {
        ...
        list: [
          { title: 'Technical Support & Digital Technology', body: 'This direction spans software, systems, and application development; data and analytics; infrastructure, networking, and cloud; cybersecurity; technical support; and digital operations. The research examines the nature of a person’s contribution across this spectrum—whether they build, operate, analyze, protect, or support technology—and the evidence that supports their experience.' },
          { title: 'Business Administration & Operations', body: 'This direction includes administrative and operational work, workflow management, project and program coordination, quality and continuous improvement, procurement, reporting, and execution follow-up. The research distinguishes between monitoring delivery, coordinating across parties, analyzing performance, and carrying responsibility for a process or decision within the scope of the role.' },
          { title: 'Sales, Retail & Customer Experience', body: 'This direction includes direct and consultative sales, retail operations, account and relationship management, customer service and experience, after-sales support, and sales operations. The research distinguishes between handling an interaction, building a relationship, managing an account, and carrying a commercial responsibility the person can genuinely support without assuming targets or results.' },
          { title: 'Finance, Accounting & Insurance', body: 'This direction ranges from accounting operations, transactions, and reconciliations to reporting, controls, auditing, insurance operations, and financial analysis within the scope of the role. The research distinguishes between data entry, review, reconciliation, analysis, control, and decision support while considering the person’s actual level of accuracy and responsibility.' },
          { title: 'Tourism, Hospitality & Events', body: 'This direction includes hospitality and travel operations, reservations, guest experience, front-office and service work, event planning and delivery, and field coordination. The research distinguishes between direct service, operational coordination, responsibility for the guest experience, planning, and professional judgment in changing situations.' },
        ],
        noteLabel: 'To be clear',
        note: 'Selecting a direction helps interpret experience within its professional environment; it does not provide an official classification or assign a final job title or fixed professional identity.',
      },
