  ...
  ar: {
    ...
    sections: {
      ...
      expression: {
        ...
        exampleLabel: 'مثال توضيحي، وليس نتيجة استخدام فعلية',
        beforeLabel: 'قبل',
        before: 'أرد على العملاء وأحل مشاكلهم.',
        afterLabel: 'بعد',
        after: 'أتعامل يوميًا مع استفسارات العملاء المتكررة، وأتابع كل حالة حتى الوصول إلى حل واضح.',
      ...
      domains: {
        ...
        list: [
          { title: 'الدعم التقني والتقنية الرقمية', body: 'قراءة المشكلات المتكررة، وتوثيق الحلول، وتحسين تجربة المستخدم النهائي.' },
          { title: 'إدارة الأعمال والعمليات', body: 'تنظيم سير العمل، وتنسيق الفرق، ورفع كفاءة التشغيل.' },
          { title: 'المبيعات والتجزئة وتجربة العميل', body: 'فهم احتياج العميل، وبناء العلاقة، وتحويل التفاعل إلى نتيجة.' },
          { title: 'المالية والمحاسبة والتأمين', body: 'الدقة في الأرقام، والالتزام بالإجراءات، والتعامل بحذر مع المسؤولية المالية.' },
          { title: 'السياحة والضيافة والفعاليات', body: 'إدارة تجربة الضيف أو الحدث، والتصرّف السريع في المواقف المتغيرة.' },
        ],
        noteLabel: 'توضيح',
        note: 'اختيار الاتجاه يساعد البحث على فهم السياق، لا على منح مسمى وظيفي نهائي أو هوية مهنية ثابتة.',
      },
  ...
  en: {
    ...
    sections: {
      ...
      expression: {
        ...
        exampleLabel: 'An illustrative example, not an actual result',
        beforeLabel: 'Before',
        before: 'I respond to customers and solve their problems.',
        afterLabel: 'After',
        after: 'I handle recurring customer inquiries daily, and follow each case through to a clear resolution.',
        noteLabel: 'The line',
      ...
      domains: {
        ...
        list: [
          { title: 'Technical Support & Digital Technology', body: 'Reading recurring issues, documenting solutions, and improving the end-user experience.' },
          { title: 'Business Management & Operations', body: 'Organizing workflows, coordinating teams, and raising operational efficiency.' },
          { title: 'Sales, Retail & Customer Experience', body: "Understanding the customer's need, building the relationship, and turning interaction into an outcome." },
          { title: 'Finance, Accounting & Insurance', body: 'Precision with numbers, adherence to procedure, and careful handling of financial responsibility.' },
          { title: 'Tourism, Hospitality & Events', body: 'Managing the guest or event experience, and acting quickly in changing situations.' },
        ],
        noteLabel: 'To be clear',
        note: 'Choosing a direction helps the research understand context — it does not assign a final job title or a fixed professional identity.',
      },
